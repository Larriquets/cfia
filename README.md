...
> A design system for a minimalist bilingual website that publishes short science-fiction stories generated by AI.

---

## Context

**Cuentos de Ficción de IA** ("AI Fiction Stories") is a greenfield project: a reading-first website where hundreds of short AI-generated sci-fi stories live. No codebase, no Figma, no existing brand — this system was designed from a brief and a short conversation.
...
│   ├── logo.svg
│   ├── logomark.svg
│   └── illustrations/         ← generative SVG illustrations
└── ui_kits/
    └── website/
        ├── README.md
